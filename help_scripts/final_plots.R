...
p1 = ggarrange(pred_conn_2, pred_conn_1, common.legend = T, legend = "bottom", labels = c("a)", "b)"), 
               font.label = list(size = 7, family = "sans", face = "plain"), ncol = 2) #, 
...
p2 = ggarrange(temp_dist_2, temp_dist_1, common.legend = T, legend = "bottom", labels = c("a)", "b)"), 
               font.label = list(size = 7, family = "sans", face = "plain"), ncol = 2)#, 
